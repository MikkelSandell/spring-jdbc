...
public class EmployeeController {
        ...
        public String createemploye(@RequestParam("id") int id, @RequestParam("name") String name,
            ...
            Employee employee = new Employee(id, name, job, manger, hiredate, salary, commisson,deponum);
            d.create(employee);
            List employees = employeeRepository.getAllEntities();
            model.addAttribute("employees", employees);
